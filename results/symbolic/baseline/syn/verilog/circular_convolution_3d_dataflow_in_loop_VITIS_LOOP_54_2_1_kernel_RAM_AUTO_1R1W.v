...
`timescale 1ns/1ps
module circular_convolution_3d_dataflow_in_loop_VITIS_LOOP_54_2_1_kernel_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 32,
    AddressRange = 64,
    AddressWidth = 6,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        circular_convolution_3d_dataflow_in_loop_VITIS_LOOP_54_2_1_kernel_RAM_AUTO_1R1W_memcore circular_convolution_3d_dataflow_in_loop_VITIS_LOOP_54_2_1_kernel_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
