...
entity circular_convolution_3d_fifo_w2_d3_S is 
    generic (
...
architecture rtl of circular_convolution_3d_fifo_w2_d3_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component circular_convolution_3d_fifo_w2_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 2;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_circular_convolution_3d_fifo_w2_d3_S_ShiftReg : circular_convolution_3d_fifo_w2_d3_S_ShiftReg
    generic map (
...
entity circular_convolution_3d_fifo_w2_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 2;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end circular_convolution_3d_fifo_w2_d3_S_ShiftReg;

architecture rtl of circular_convolution_3d_fifo_w2_d3_S_ShiftReg is
