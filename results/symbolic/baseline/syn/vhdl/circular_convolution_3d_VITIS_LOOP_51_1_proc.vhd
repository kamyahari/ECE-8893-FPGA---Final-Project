...
entity circular_convolution_3d_VITIS_LOOP_51_1_proc is
port (
...
architecture behav of circular_convolution_3d_VITIS_LOOP_51_1_proc is 
...
attribute shreg_extract : string;
    signal dataflow_parent_loop_proc_U0_A_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal dataflow_parent_loop_proc_U0_A_ce0 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_A_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_parent_loop_proc_U0_A_we0 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_A_address1 : STD_LOGIC_VECTOR (13 downto 0);
    signal dataflow_parent_loop_proc_U0_A_ce1 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_A_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_parent_loop_proc_U0_A_we1 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_B_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal dataflow_parent_loop_proc_U0_B_ce0 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_B_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_parent_loop_proc_U0_B_we0 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_B_address1 : STD_LOGIC_VECTOR (13 downto 0);
    signal dataflow_parent_loop_proc_U0_B_ce1 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_B_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_parent_loop_proc_U0_B_we1 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_C_address0 : STD_LOGIC_VECTOR (13 downto 0);
    signal dataflow_parent_loop_proc_U0_C_ce0 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_C_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_parent_loop_proc_U0_C_we0 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_C_address1 : STD_LOGIC_VECTOR (13 downto 0);
    signal dataflow_parent_loop_proc_U0_C_ce1 : STD_LOGIC;
    signal dataflow_parent_loop_proc_U0_C_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_parent_loop_proc_U0_C_we1 : STD_LOGIC;
    ...
    component circular_convolution_3d_dataflow_parent_loop_proc IS
    port (
        A_address0 : OUT STD_LOGIC_VECTOR (13 downto 0);
        A_ce0 : OUT STD_LOGIC;
        A_d0 : OUT STD_LOGIC_VECTOR (31 downto 0);
...
begin
    dataflow_parent_loop_proc_U0 : component circular_convolution_3d_dataflow_parent_loop_proc
    port map (
    ...
    begin
        if (((loop_dataflow_output_count = ap_const_lv5_0) and (ap_start = ap_const_logic_0) and (dataflow_parent_loop_proc_U0_ap_idle = ap_const_logic_1))) then 
