...
entity circular_convolution_3d_fifo_w32_d32_S_x is 
    generic (
...
architecture rtl of circular_convolution_3d_fifo_w32_d32_S_x is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component circular_convolution_3d_fifo_w32_d32_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
...
begin
----------------------- Instantiation -----------------------
    U_circular_convolution_3d_fifo_w32_d32_S_x_ShiftReg : circular_convolution_3d_fifo_w32_d32_S_x_ShiftReg
    generic map (
...
entity circular_convolution_3d_fifo_w32_d32_S_x_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end circular_convolution_3d_fifo_w32_d32_S_x_ShiftReg;

architecture rtl of circular_convolution_3d_fifo_w32_d32_S_x_ShiftReg is
