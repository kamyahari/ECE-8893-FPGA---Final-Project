...
template <int N> // template specialization for 1D weights
...
template <int IN, int OUT> // template specialization for 2D weights
...
int main()
{
    ...
    //hls::vector<data_t, WIDTH> input_vector[BATCH][IN_CHANNELS][HEIGHT];
   ...
   // hls::vector<data_t, OUT_CHANNELS> block0_gamma1_vector;
   ...
   // static data_t block0_output_conv2[BATCH][OUT_CHANNELS][HEIGHT / 2][WIDTH / 2];
   ...
   // static data_t block1_output_conv1[BATCH][OUT_CHANNELS][HEIGHT / 2][WIDTH / 2];
    ...
    //static data_t block1_output_conv2[BATCH][OUT_CHANNELS][HEIGHT / 2][WIDTH / 2];
    ...
    //static data_t input_local[BATCH][IN_CHANNELS][HEIGHT][WIDTH];
    ...
    // load block 0 output
    //  load_4d_input<BATCH, OUT_CHANNELS, HEIGHT/2, WIDTH/2>("block0_output.bin", block0_output_reference);
    //  std::cout << "Loaded block 0 output!" << std::endl;

    // load 2d avgpool
    //  load_2d_weights<BATCH, OUT_CHANNELS>("avgpool_output.bin", avgpool_output_reference);
    //  std::cout << "Loaded average pool output !" << std::endl;
    ...
    //double mse2 = compute_mse2(block1_output_conv1, block0_bn1_output_reference);
    double mse = compute_mse(tanh_output, ref_output);
    
    // std::cout << "MSE compared to reference block0 after bn1: " << mse2 << std::endl;
    ...
    else
    {
        ...
        // print first 5 value of each batch
        // print first 5 values of block0 output
        // std::cout << "Downsameple bn1" << std::endl;
        // std::cout<<block1_output_conv1[0][0][1][19]<<" "<<block1_output_conv1[0][0][1][0]<<" "<<block1_output_conv1[0][0][1][1]<<" "<<block1_output_conv1[0][0][1][2]<<" "<<block1_output_conv1[0][0][1][3]<<std::endl;
        // std::cout << "Block 0 Bn2 output" << std::endl;
        //Expect 0.084 in 4th
       // std::cout << block0_output_bn2[0][0][1][19] << " " << block0_output_bn2[0][0][1][0] << " " << block0_output_bn2[0][0][1][1] << " " << block0_output_bn2[0][0][1][2] << " " << block0_output_bn2[0][0][1][3] << std::endl;
        std::cout << std::endl;
        std::cout << "CONV2 Weights" << std::endl;
        std::cout << block1_weights_conv1[0][0][0][0] << " " << block1_weights_conv1[0][0][1][0]<<std::endl;
