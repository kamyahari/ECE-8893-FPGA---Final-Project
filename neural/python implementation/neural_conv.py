...
#Accessing weights
print("Description of layer 4 first block: ",last_layer.layer4[0])
first_block_layer4 = last_layer.layer4[0]

# Get the weights for 1st conv2d of layer 4
conv1_layer4 = first_block_layer4.conv1
weights_layer4_conv1 = conv1_layer4.weight.data
print("Shape of the weights of first conv2d of layer 4: ",weights_layer4_conv1.shape)
# Convert to numpy array
np_weights = weights_layer4_conv1.detach().cpu().numpy()
# Save to disk
output_save_path_weights = output_save_path+"/layer4_block1_conv1_weights.npy"
np.save(output_save_path_weights, np_weights) 


# Get the weights for second conv2d of layer 4
conv1_layer4 = first_block_layer4.conv2
weights_layer4_conv1 = conv1_layer4.weight.data
print("Shape of the weights of second conv2d of layer 4: ",weights_layer4_conv1.shape)
# Convert to numpy array
np_weights = weights_layer4_conv1.detach().cpu().numpy()

# Save to disk
output_save_path_weights = output_save_path+"/layer4_block1_conv2_weights.npy"
np.save(output_save_path_weights, np_weights) 

#get downsample weights
downsample_layer4 = first_block_layer4.downsample
if downsample_layer4 is not None:
    conv1_downsample = downsample_layer4[0]
    weights_downsample_conv1 = conv1_downsample.weight.data
    print("Shape of the weights of downsample conv2d of layer 4: ",weights_downsample_conv1.shape)
    # Convert to numpy array
    np_weights = weights_downsample_conv1.detach().cpu().numpy()
    # Save to disk
    output_save_path_weights = output_save_path+"/layer4_block1_downsample_weights.npy"
    np.save(output_save_path_weights, np_weights)

#get weights from block 2
first_block_layer4 = last_layer.layer4[1]
conv1_layer4 = first_block_layer4.conv1
weights_layer4_conv1 = conv1_layer4.weight.data
print("Shape of the weights of first conv2d of layer 4: ",weights_layer4_conv1.shape)
# Convert to numpy array
np_weights = weights_layer4_conv1.detach().cpu().numpy()
# Save to disk
output_save_path_weights = output_save_path+"/layer4_block2_conv1_weights.npy"
np.save(output_save_path_weights, np_weights)
...
np_weights = weights_layer4_conv1.detach().cpu().numpy()
# Save to disk
output_save_path_weights = output_save_path+"/layer4_block2_conv2_weights.npy"
np.save(output_save_path_weights, np_weights)
